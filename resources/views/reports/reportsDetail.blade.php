...
<head>
    ...
    <style>
        ...
        border-collapse: collapse;
        width: 100%;
        margin-bottom: 20px; /* Adds space after the table */
        }
        ...
        .line {
                border-top: 2px solid black; /* Adjust the thickness and color as needed */
                margin-top: 20px; /* Adjust the margin to set the space between the tables */
            }
    </style>
</head>
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            @foreach ($customerDetails as $row)
                ...
                @php
                    $totalPrice += $row->price; // Adding the price to the total
                @endphp
            @endforeach
        </tbody>
        <tfoot>
